        ...
        <main class="max-w-lg mx-auto mt-10 bg-gray-100 border border-gray-200 p-6 rounded-xl">
            ...
            <form action="/register" method="POST" class="mt-10">
                ...
                <div class="mb-6">
                    ...
                    <input class="border border-grey-400 p-2 w-full" type="text" name="name" id="name" value="{{ old('name') }}"
                        required>
                </div>
                @error('name')
                ...
                <div class="mb-6">
                    ...
                    <input class="border border-grey-400 p-2 w-full" type="text" name="username" id="username" value="{{ old('username') }}"
                        required>
                </div>
                @error('username')
                    <p class="text-red-500 text-xs mt-1">
                ...
                <div class="mb-6">
                    ...
                    <input class="border border-grey-400 p-2 w-full" type="email" name="email" id="email" value="{{ old('email') }}"
                        required>
                </div>
                @error('email')
                    <p class="text-red-500 text-xs mt-1">
